...
TrajectoryGenerator* m_generator_p;
...
bool createPolynomialTrajectory(trajectory_generator::polynomial_trajectory::Request &req,
    ...
    res.finished = m_generator_p->createAndSendTrajectory(req.x_start, req.x_end, req.rpy_start, req.rpy_end, req.delta_t,TrajTypes::Polynomial);
    return true;
}
...
bool createLinearTrajectory(trajectory_generator::linear_trajectory::Request &req,
    ...
    res.finished = m_generator_p->createAndSendTrajectory(req.x_start, req.x_end, req.rpy_start, req.rpy_end, req.delta_t,TrajTypes::Linear);
    return true;
}
...
int main(int argc, char **argv)
{
    ...
    m_generator_p = &m_generator; //set pointer for global variable
