...
# show path
plt.figure(1)
plt.scatter(data1['vel1'],data1['f_z_1'], marker='x', label='motor1')
plt.scatter(data1['vel2'],data1['f_z_2'], marker='+', label='motor2')
plt.scatter(data1['vel3'],data1['f_z_3'], marker='x', label='motor3')
plt.scatter(data1['vel4'],data1['f_z_4'], marker='+', label='motor4')
plt.scatter(data1['vel5'],data1['f_z_5'], marker='x', label='motor5')
plt.scatter(data1['vel6'],data1['f_z_6'], marker='+', label='motor6')
plt.xlabel('vel_sq')
